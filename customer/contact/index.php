...
<div class="section">
    <h2 class="page-title" style="padding:0 0 14px"><?= svgIcon('map-pin',22) ?> Hubungi Kami</h2>
    ...
    <div style="background:var(--white);border-radius:var(--radius);box-shadow:var(--shadow);padding:20px;margin-bottom:14px;text-align:center">
        <div style="font-size:3rem;margin-bottom:8px"><?= svgIcon('food',48) ?></div>
        ...
        <div style="text-align:left;max-width:320px;margin:0 auto">
            <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--gray-light)">
                <span style="font-size:1.2rem"><?= svgIcon('map-pin',20) ?></span>
                <div>
            ...
            <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--gray-light)">
                <span style="font-size:1.2rem"><?= svgIcon('phone',20) ?></span>
                <div>
            ...
            <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--gray-light)">
                <span style="font-size:1.2rem"><?= svgIcon('mail',20) ?></span>
                <div>
            ...
            <div style="display:flex;align-items:center;gap:12px;padding:10px 0">
                <span style="font-size:1.2rem"><?= svgIcon('clock',20) ?></span>
                <div>
    ...
    <div style="background:var(--white);border-radius:var(--radius);box-shadow:var(--shadow);padding:20px;margin-bottom:14px">
        <h3 style="font-size:14px;font-weight:700;margin-bottom:14px;text-align:center"><?= svgIcon('cart',18) ?> Cara Pesan</h3>
    ...
    <div style="background:var(--white);border-radius:var(--radius);box-shadow:var(--shadow);padding:20px;text-align:center">
        <h3 style="font-size:14px;font-weight:700;margin-bottom:8px"><?= svgIcon('credit-card',18) ?> Pembayaran</h3>
